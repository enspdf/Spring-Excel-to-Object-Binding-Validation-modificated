...
import org.prabu.spring.excel.objectbinding.domain.Example;
...
import org.prabu.spring.excel.objectbinding.validator.ExampleValidator;
    				  ...
    				  ExecutorService executorService = Executors.newFixedThreadPool(Runtime.getRuntime().availableProcessors()*16);
    		            ...
    		            try {
    						...
    						ExcelFile excelFile = new ExcelFile(workbook.getSheetAt(0), true, 2000,
    								fileUploadTemplateHandler.getUserfileTemplate(), Example.class,
									exampleValidator
    								);
